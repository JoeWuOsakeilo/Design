...
<!-- Common -->
<link href="${contextRoot}/static/back/assets/css/lib/font-awesome.min.css" rel="stylesheet">
<link href="${contextRoot}/static/back/assets/css/lib/themify-icons.css" rel="stylesheet">
<link href="${contextRoot}/static/back/assets/css/lib/menubar/sidebar.css" rel="stylesheet">
<link href="${contextRoot}/static/back/assets/css/lib/bootstrap.min.css" rel="stylesheet">
<link href="${contextRoot}/static/back/assets/css/lib/helper.css" rel="stylesheet">
<link href="${contextRoot}/static/back/assets/css/style.css" rel="stylesheet">
